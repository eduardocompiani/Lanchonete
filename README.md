...
-- TO-DO CRIAR TRIGGER PARA ATUALIZAR O PREÇO DO COMBO 
CREATE TABLE PEDIDO(
...
-- TO-DO CRIAR TRIGGER PARA ATUALIZAR O PREÇO DO PEDIDO
...
#CRIO O COMBO
INSERT INTO COMBO(NMCOMBO, VLDESCONTO) VALUES ('MC BURGUER', 5);
